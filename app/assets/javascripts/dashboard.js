...
function newRatingStarsHover(){
  ...
  $("form .new-rating-stars").mouseenter(function(event){
    ...
    $("#"+ parentId + " #"+ hoveredStarId +"").css('background', "url('../../public/star-full.png')");
    $("#"+parentId + " #"+ hoveredStarId +"").prevAll().css('background', "url('../../public/star-full.png')");
  });

  $("form .new-rating-stars").mouseleave(function(event){
    var hoveredStarId = event.currentTarget.id
    var parentId = event.currentTarget.parentElement.id
    $("#"+parentId + " #"+ hoveredStarId +"").css('background', "url('../../public/star-empty.png')");
    $("#"+parentId + " #"+ hoveredStarId +"").prevAll().css('background', "url('../../public/star-empty.png')");
  });
}
...
function newRatingStarsClick(){
  $('.new-rating-stars').on('click', function(event){
    ...
    $("#"+parentId+" .new-rating-stars").css('background', "url('../../public/star-empty.png')")
    ...
    $("#newrating-" + outfitIndex + " div:lt("+ starNumber +")").css('background', "url('../../public/star-full.png')")
...
function addAverageRating(data) {
 for (var i = 0; i < data.length ; i++ ) {
  ...
  if (rating > 0) {
    $("#rating-" + i + " div:lt("+ rating +")").css('background', "url('../../public/star-full.png')")
  }
}
}
